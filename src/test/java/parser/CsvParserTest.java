...
public class CsvParserTest {
    ...
    public void variablesNullOnWrongSeparator() throws IOException {
        ...
        List<DatablockMock> result = CsvParser.parseDatablocks(WRONG_SEPARATOR_FILE_PATH, DatablockMock.class);
    ...
    public void parseMultipleDatablocks() throws IOException {
        ...
        fileWriter.close();
        List<DatablockMock> result = CsvParser.parseDatablocks(VALID_DATABLOCKS_FILE_PATH, DatablockMock.class);
    ...
    public void doubleColumnNamesOverwrite() throws IOException {
        ...
        List<DatablockMock> result = CsvParser.parseDatablocks(DOUBLE_COLUMN_NAME_FILE_PATH, DatablockMock.class);
        assertEquals(1, result.size());
    ...
    public void switchedColumnNames() throws IOException {
        ...
        fileWriter.close();
        List<DatablockMock> result = CsvParser.parseDatablocks(SWITCHED_COLUMN_NAMES_FILE_PATH, DatablockMock.class);
        assertEquals(1, result.size());
